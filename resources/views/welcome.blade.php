...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('sipenmaru/images/logo enrollify.png') }}">
    ...
    <div class="container">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                {{-- <img src="{{ asset('sipenmaru/images/Isolation Mode.png') }}" class="image" alt="" /> --}}
            </div>
            <div class="panel right-panel">
                ...
                {{-- <img src="{{ asset('sipenmaru/images/register 1.png') }}" class="image" alt="" /> --}}
            </div>
        </div>
    </div>
