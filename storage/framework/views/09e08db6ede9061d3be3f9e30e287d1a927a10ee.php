                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="update-jadwal/<?php echo e($x->id); ?>" method="POST"
                                                        ...
                                                        <input type="hidden" name="userid" value="<?php echo e(auth()->user()->id); ?>">
                                                        <input type="hidden" name="id" value="<?php echo e($x->id); ?>">
                                                        
                                                        <div class="form-group">
                                                            <label for="iduser">Nama Kegiatan</label>
                                                            <input type="text" class="form-control" id="nama"
                                                                        placeholder="Masukkan nama kegiatan: Gelombang 1" name="nama" value="<?php echo e($x->nama_kegiatan); ?>" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="iduser">Jenis Kegiatan</label>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-lg-6 col-xl-6 col-md-6">
                                                                    <label for="iduser">Tanggal Mulai</label>
                                                                    <input type="date" class="form-control" name="mulai" value="<?php echo e($x->tgl_mulai); ?>"  required>
                                                                </div>
                                                                <div class="col-lg-6 col-xl-6 col-md-6">
                                                                    <label for="iduser">Tanggal Selesai</label>
                                                                    <input type="date" class="form-control" name="selesai" value="<?php echo e($x->tgl_akhir); ?>" required>
                                                                </div>
                                                            </div>
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/jadwalkegiatan/data-jadwal.blade.php ENDPATH**/ ?>