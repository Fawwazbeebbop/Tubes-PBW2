                ...
                <div class="card-body">
                    <div class="table-responsive" id="cetak">
                        ...
                        <table id="example3" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $dataUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <?php if($x->profile->foto != null): ?>
                                                <img class=" rounded-circle img-thumbnail" src="<?php echo e(url('/' . $x->profile->foto)); ?>"
                                                    alt="" width="45px" />
                                            <?php else: ?>
                                                <img class="rounded-circle img-thumbnail"
                                                    src="<?php echo e(asset('sipenmaru/images/ava.png')); ?>" alt="" width="45px" />
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($x->profile->nama); ?></td>
                                        <td>
                                            <?php if($x->profile->gender == 'Perempuan'): ?>
                                                <span class="badge badge-secondary">Perempuan</span>
                                            <?php elseif($x->profile->gender == 'Laki-laki'): ?>
                                                <span class="badge"
                                        ...
                                        <td><strong><?php echo e($x->profile->no_hp); ?></strong></a></td>
                                        <td><a href="javascript:void(0);"><strong><?php echo e($x->email); ?></strong></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <a class="btn btn-light shadow btn-xs sharp me-1" title="Data Registration"
                                                    href="data-user/edit/<?php echo e($x->id); ?>"><i class="fa fa-file-alt"></i></a>
                                                <a class="btn btn-primary shadow btn-xs sharp me-1" title="Edit"
                                                    href="<?php echo e(route('edit-user',$x->id)); ?>"><i
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center"><i
                                                                    ...
                                                                    menghapus data ini?<br> <?php echo e($x->id); ?>

                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-danger light"
                                                                        data-bs-dismiss="modal">Batalkan</button>
                                                                    <a href="<?php echo e(route('delete-user',$x->id)); ?>">
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/user/data-user-admin.blade.php ENDPATH**/ ?>