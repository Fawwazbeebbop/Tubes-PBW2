                                    ...
                                    <?php $__currentLoopData = $viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php endif; ?>
                                            <td><?php if($x->hasil_seleksi == "LULUS" || $x->hasil_seleksi == "Lulus" || $x->hasil_seleksi == "lulus"): ?> 
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center"><i
                                                                        class="fa fa-trash"></i><br> Apakah anda yakin ingn menghapus data ini? <br><?php echo e($x->id_pengumuman); ?>
                                        ...
                                        <div class="modal fade edit<?php echo e($x->id_pengumuman); ?>" tabindex="-1" role="dialog"
                                                        ...
                                                        <form action="update-announcement/<?php echo e($x->id_pengumuman); ?>"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-6">
                                                                        ...
                                                                        <select class="default-select form-control wide"
                                                                            ...
                                                                            <option value="<?php echo e($x->id_pendaftaran); ?>">
                                                                                <?php echo e($x->pendaftaran->id_pendaftaran); ?></option>
                                                                        </select>
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        ...
                                                                        <select class="default-select form-control wide"
                                                                            ...
                                                                            <option value="<?php echo e($x->hasil_seleksi); ?>" selected><?php echo e($x->hasil_seleksi); ?></option>
                                                                            <option value="LULUS">LULUS</option>
                                                                            <option value="TIDAK LULUS">TIDAK LULUS</option>
                                                                        </select>
                                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="default-select form-control wide"
                                                                    ...
                                                                    <?php if($x->hasil_seleksi == "LULUS" || $x->hasil_seleksi == "Lulus" || $x->hasil_seleksi == "lulus"): ?> 
                                                                    <option value="<?php echo e($x->prodi_penerima); ?>" selected><?php echo e($x->prodi->nama_prodi); ?></option>
                                                                    <?php endif; ?>
                                                                    <option value="<?php echo e($x->pendaftaran->pil1); ?>">Pilihan 1 : <?php echo e($x->pendaftaran->pilihan1->nama_prodi); ?></option>
                                                                    <option value="<?php echo e($x->pendaftaran->pil2); ?>">Pilihan 2 : <?php echo e($x->pendaftaran->pilihan2->nama_prodi); ?></option>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        ...
                                                                        <input type="number" class="form-control" id="nama"
                                                                            value="<?php echo e($x->nilai_test); ?>" name="test"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        <div class="card card-body" >
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-4">
                        <img src="<?php echo e(asset('sipenmaru/images/chart.png')); ?>" alt="" class="sd-shape">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/pengumuman/data-pengumuman-admin.blade.php ENDPATH**/ ?>