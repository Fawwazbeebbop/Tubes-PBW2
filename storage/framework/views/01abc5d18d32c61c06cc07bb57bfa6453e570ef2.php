                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="text" class="form-control" id="personal-data-nisn"
                                                name="nisn" placeholder="Masukkan NISN" value="<?php echo e(old('nisn')); ?>" required>
                                        ...
                                        <div class="mb-3 mb-4">
                                            ...
                                            <?php if( auth()->user()->profile->nama  != null): ?>
                                                <input type="text" class="form-control" id="basicpill" name="nama"
                                                    placeholder="Masukkan Nama Lengkap" value="<?php echo e(auth()->user()->profile->nama); ?>" required>
                                            <?php else: ?>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="foto" value="<?php echo e(old('foto')); ?>" accept="image/png, image/jpg, image/jpeg" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-3 mb-4">
                                            ...
                                            <?php if(auth()->user()->profile->no_hp != null): ?>
                                                <input type="number" class="form-control" id="basicpill" name="nohp"
                                                    placeholder="Masukkan Tanggal Lahir" value="<?php echo e(auth()->user()->profile->no_hp); ?>" required>
                                            <?php else: ?>
                                                <input type="number" class="form-control" id="basicpill" name="nohp"
                                                    placeholder="Masukkan nomor telepon" value="<?php echo e(old('nohp')); ?>" required>
                                            <?php endif; ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="ftberkas_ortu" value="<?php echo e(old('ftberkas_ortu')); ?>" accept="application/pdf" required>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" class="form-control" name="smt1"
                                                placeholder="Masukkan Rata Nilai Semester" value="<?php echo e(old('smt1')); ?>" required>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" class="form-control" name="smt2"
                                                placeholder="Masukkan Rata Nilai Semester" value="<?php echo e(old('smt2')); ?>" required>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" class="form-control" name="smt3"
                                                placeholder="Masukkan Rata Nilai Semester" value="<?php echo e(old('smt3')); ?>" required>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" class="form-control" name="smt4"
                                                placeholder="Masukkan Rata Nilai Semester" value="<?php echo e(old('smt4')); ?>" required>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="number" class="form-control" name="smt5"
                                                placeholder="Masukkan Rata Nilai Semester" value="<?php echo e(old('smt5')); ?>" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="ftberkas_siswa" value="<?php echo e(old('ftberkas_siswa')); ?>" accept="application/pdf" required>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="ftprestasi" value="<?php echo e(old('ftprestasi')); ?>" accept="application/pdf" >
                                                </div>
                                            </div>
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/pendaftaran/data-pendaftaran-input-admin.blade.php ENDPATH**/ ?>