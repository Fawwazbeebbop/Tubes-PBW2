                        ...
                        <div class="card tryal-gradient">
                            <div class="card-body tryal row">
                                <div class="col-xl-7 col-sm-6">
                                    ...
                                    <a href="<?php echo e(route('data-registration')); ?>" class="btn btn-rounded  fs-18 font-w500">Lihat
                                        pendaftar</a>
                                </div>
                                    ...
                                    <div class="card-body px-4 pb-0">
                                        ...
                                        <div class="progress default-progress">
                                            ...
                                            <div class="progress-bar bg-gradient1 progress-animated"
                                                style="width: <?php echo e($hasilpersenan); ?>%; height:10px;"
                                                role="progressbar">
                                            </div>
                                    ...
                                    <div class="card-body d-flex px-4  justify-content-between">
                                        <div>
                                            <div class="">
                                                ...
                                                <h5 class="fs-32 font-w700"><?php echo e(number_format($jmlbayar * 150000, 0, 0, '.')); ?></h5>
...
</div><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/dashboard/dashboard-admin.blade.php ENDPATH**/ ?>