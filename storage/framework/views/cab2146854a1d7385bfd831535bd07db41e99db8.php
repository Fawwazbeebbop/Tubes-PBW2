                    ...
                    <div class="p-4">
                        <div class="d-flex">
                            <div class="col-lg-3" style="text-align: center; margin-right:25px; margin-left:25px;">
                                <img width="110px" src="<?php echo e(asset('sipenmaru/images/logo.jpg')); ?>" alt="">
                            </div>
                            <div class="col-lg-6">
                                <center>
                                    ...
                                    <h5 style="margin-top: -0.5rem"> <strong class="d-block">PENERIMAAN MAHASISWA BARU</strong></h4>
                                        <h4 style="margin-top: -0.5rem"><strong class="d-block">ITENAS</strong></h3>
                                            <p style="margin-top: -0.5rem"><strong class="d-block">Jl. PH. H. Mustofa No. 23 Bandung, Jawa Barat <br> 40124</strong></p>
                                </center>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-4" style="border-top: 2px solid black!important; margin-top:-2.5rem;">
                            ...
                            <div class="d-flex">
                                <div class="col-lg-6" style="width:50%; text-align: right; margin:15px;">
                                    <img width="150px" src="<?php echo e(asset('sipenmaru/images/qr.png')); ?>" alt="">
                                </div>
                                <div class="col-lg-6" style="width:50%;">
                                    <br>
                                    <center>
                                        <h5><label class="form-label"><strong
                                                    class="d-block">...............................,2023</strong></label>
                                        </h5>
                                        <br>
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/pendaftaran/data-pendaftaran-kartu-admin.blade.php ENDPATH**/ ?>