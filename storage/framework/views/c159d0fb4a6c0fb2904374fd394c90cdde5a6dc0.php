    ...
    <?php if(auth()->guard()->check()): ?>
        <ul class="metismenu" id="menu">
            ...
            <?php if(auth()->user()->role == 'Administrator'): ?>
                ...
                <li class="mm-active"><a href="<?php echo e(route('data-pengumuman')); ?>" aria-expanded="false">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        <div class="mb-3">
                            ...
                            <span>didaftarkan oleh <strong><?php echo e(auth()->user()->name); ?></strong> pada
                                <?php echo e($viewIdPendaftaran->tgl_pendaftaran); ?></span>
                        </div>
                        <div class="mb-3">
                            <div class="d-flex align-items-center mb-4 pb-3 justify-content-end flex-wrap">
                                <div class="me-3">
                                    <h4 class="fs-18 font-w600">PMB ITENAS</h4>
                                    <span>Jl. PH. H. Mustofa No. 23<br>Bandung 40124 Indonesia</span>
                                </div>
                                <div class="me-3">
                                    <img src="<?php echo e(asset('sipenmaru/images/logo.png')); ?>" alt="" width="50px">
                                </div>
                                <!--
                                        <div>
                                            <div class="dropdown">
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody border="5">
                                    ...
                                    <tr border="5">
                                        <td scope="row" width="70%">
                                            <table>
                                                <tr border="5">
                                                    ...
                                                    <td  width="50%"><?php echo e($viewIdPendaftaran->id_pendaftaran); ?></td>
                                                <tr>
                                                <tr border="5">
                                                    <th scope="row"  width="50%">NISN Siswa</th>
                                                    <td width="50%"><?php echo e($viewIdPendaftaran->nisn); ?></td>
                                                </tr>
                                                <tr border="5">
                                                    <th scope="row"  width="50%">Nama Siswa</th>
                                                    <td  width="50%"><?php echo e($viewIdPendaftaran->nama_siswa); ?></td>
                                                </tr>
                                                <tr border="5">
                                                    <th scope="row"  width="50%">Asal Sekolah</th>
                                                    <td width="50%">
                                                        
                                                        <?php $__currentLoopData = $viewSekolah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($viewIdPendaftaran->sekolah == $item->id): ?>
                                                         <?php echo e($item->nama_sekolah); ?>
                                        ...
                                        <td colspan="4"><img src="<?php echo e(url('/'.$viewIdPendaftaran->pas_foto)); ?>" alt="" width="180px" height="240"></td>
                                    <tr>
                                    ...
                                    <tr border="5">
                                        <th colspan="3" scope="row">
                                            ...
                                            <?php $__currentLoopData = $viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($x->hasil_seleksi == 'TIDAK LULUS' && $x->id_pendaftaran== $viewIdPendaftaran->id): ?>
                                                    ...
                                                    <?php elseif($x->hasil_seleksi == 'LULUS' && $x->id_pendaftaran== $viewIdPendaftaran->id): ?>
                                                        ...
                                                        <div class="alert alert-outline-success alert-dismissible fade show" style="border-radius: 0%; margin-top:-1rem">
                                                            <table>
                                                                <tr>
                                                                    <th scope="row">Program Studi Penerima <b><?php echo e($x->prodi->nama_prodi); ?></b></th>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    <?php endif; ?>
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/pengumuman/data-pengumuman-view.blade.php ENDPATH**/ ?>