...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="custom-accordion">
                ...
                <div class="row my-4">
                    <div class="col">
                        <div class="text-end mt-2 mt-sm-0">
                            ...
                            <a href="../../verified-registration/<?php echo e($viewData->id_pendaftaran); ?>"><button type="button" class="btn btn-primary">Verified</button></a>
                            <?php endif; ?>
                            <a href="../../card-registration/<?php echo e($viewData->id); ?>"><button type="button" class="btn btn-primary">View Card </button></a>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
                ...
                <?php elseif($viewData->status_pendaftaran=="Terverifikasi" && $viewDataPembayaran->status !="Gratis" && $viewDataPembayaran->status !="Dibayar"): ?>
                ...
                <?php endif; ?>
                <div class="text-end">
                    <a href="../../card-registration/<?php echo e($viewData->id); ?>"><button type="button" class="btn btn-primary">Lihat Kartu Pendaftaran </button></a>
                </div>
                <?php endif; ?>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?php echo e(route('upload-payment')); ?>" method="POST" enctype="multipart/form-data">
                                        <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="<?php echo e($viewData->id_pendaftaran); ?>">
                                            <div class="row">
                                                <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-8 col-6">
                                        <h5 class="f-w-500">: <?php echo e($viewData->tempat_lahir); ?>,<?php echo e($viewData->tanggal_lahir); ?></h5>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-4 col-6">
                            ...
                            <div class="col-lg-6">
                                <div class="pt-4 border-bottom-1 pb-3">
                                    <img src="<?php echo e(asset($viewData->pas_foto)); ?>" width="250px" height="300" alt="">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12 col-12">
                                        ...
                                        <div class="col-sm-9 col-7">
                                            <a href="<?php echo e(asset($viewData->berkas_siswa)); ?>"> <i class="fa fa-file-pdf" style="font-size:48px;color:red"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/pendaftaran/data-pendaftaran-detail.blade.php ENDPATH**/ ?>