                                        ...
                                        <?php $__currentLoopData = $viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <?php if($x->status_pendaftaran == 'Terverifikasi'): ?>
                                                                <span class="badge badge-success">Terverifikasi<span
                                                                        class="ms-1 fa fa-check"></span>
                                                                <?php elseif($x->status_pendaftaran == 'Belum Terverifikasi'): ?>
                                                                    <span class="badge badge-warning">Belum <br> Terverifikasi
                                                                        <br><span class="ms-1 fas fa-stream"></span>
                                                                    <?php elseif($x->status_pendaftaran == 'Selesai'): ?>
                                                            ...
                                                            <div class="dropdown text-sans-serif"><button
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end border py-0"
                                                                    ...
                                                                    <div class="py-2"><a class="dropdown-item"
                                                                            ...
                                                                            href="/finish-registration/<?php echo e($x->id_pendaftaran); ?>">Selesai
                                                                            </a>
                                                                    </div>
                                                                        <div class="dropdown-divider"></div><a
                                                            ...
                                                            <div class="modal-dialog modal-sm">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body text-center"><i
                                                                        ...
                                                                        menghapus data ini?<br><?php echo e($x->id_pendaftaran); ?>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a
                                                                            href="delete-registration/<?php echo e($x->id_pendaftaran); ?>">
        ...
        <?php elseif(auth()->user()->role == 'Calon Mahasiswa'): ?>
            ...
            <div class="project-page d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="mb-4">
                    ...
                    ?>
                    <?php $__currentLoopData = $viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(auth()->user()->email == $x->email): ?>
                            <?php
                                $no = $no + 1;
                            ?>
                        <?php endif; ?>
                        ...
                        <div class="col-xl-12">
                            <div class="tab-content">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-xl-3  col-lg-6 col-sm-6 mb-sm-4 mb-0">
                                                    <div class="d-flex project-image">
                                                        ...
                                                        <div>
                                                            <small
                                                                class="d-block fs-16 font-w400"><?php echo e($x->pilihan1->nama_prodi); ?></small>
                                                            <span class="fs-18 font-w500"><?php echo e($x->pilihan2->nama_prodi); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-2  col-lg-6 col-sm-4 mb-sm-3 mb-3 text-end">
                                                    <div class="d-flex justify-content-end project-btn">
                                                        <?php if($x->status_pendaftaran == 'Belum Terverifikasi'): ?>
                                                            <a href="detail-registration/<?php echo e($x->id_pendaftaran); ?>"
                                                                class=" btn bgl-warning text-warning fs-16 font-w600">Belum <br>
                                                                Terverifikasi</a>
                                                        <?php elseif($x->status_pendaftaran == 'Terverifikasi'): ?>
                                                            <a href="detail-registration/<?php echo e($x->id_pendaftaran); ?>"
                                                        ...
                                                        <div class="dropdown ms-4  mt-auto mb-auto">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item"
                                                                    href="detail-registration/<?php echo e($x->id_pendaftaran); ?>">Lihat
                                                                    Selengkapnya</a>
                                                                <?php if($x->status_pendaftaran == 'Selesai'): ?>
                                                                    <a class="dropdown-item"
                                                                    href="view-announcement/<?php echo e($x->id_pendaftaran); ?>">Lihat
                                                                    Pengumuman</a>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                ...
                                <div class="tab-pane fade" id="OnProgress">
                                    <?php if($x->status_pendaftaran == 'Belum Terverifikasi' || $x->status_pendaftaran == 'Terverifikasi'): ?>
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    <div class="col-xl-4  col-lg-6 col-sm-12 align-items-center customers">
                                                        <span class="text-primary d-block fs-18 font-w500 mb-1"
                                                            style="margin-top: -1.5rem"><?php echo e($x->id_pendaftaran); ?></span>
                                                        <span class="d-block mb-lg-0 mb-0 fs-16"><i
                                                                class="fas fa-calendar me-3"></i>Didaftarkan tanggal
                                                            <?php echo e($x->tgl_pendaftaran); ?></span>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-3  col-lg-6 col-sm-6 mb-sm-4 mb-0">
                                                        <div class="d-flex project-image">
                                                            ...
                                                            <div>
                                                                <small
                                                                    class="d-block fs-16 font-w400"><?php echo e($x->gelombang); ?></small>
                                                                <span class="fs-18 font-w500"><?php echo e($x->pil1); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-2  col-lg-6 col-sm-4 mb-sm-3 mb-3 text-end">
                                ...
                                <div class="tab-pane fade" id="Closed">
                                    <?php if($x->status_pendaftaran == 'Tidak Sah'): ?>
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    <div class="col-xl-4  col-lg-6 col-sm-12 align-items-center customers">
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/pendaftaran/data-pendaftaran-admin.blade.php ENDPATH**/ ?>