                        ...
                        <table id="example3" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($no++); ?></td>
                                        <td><?php echo e($x->NPSN); ?></td>
                                        <td><?php echo e($x->nama_sekolah); ?></td>
                                        <td><?php echo e($x->alamat); ?></td>
                                        <td><?php echo e($x->kota); ?></td>
                                        <td>
                                            <div class="d-flex">
                                                <a class="btn btn-primary shadow btn-xs sharp me-1" title="Edit"
                                                    data-bs-toggle="modal" data-bs-target=".edit<?php echo e($x->NPSN); ?>"><i
                                                        class="fa fa-pencil-alt"></i></a>
                                                <a class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"
                                                        data-bs-toggle="modal"
                                                        data-bs-target=".delete<?php echo e($x->NPSN); ?>"></i></a>
                                                <div class="modal fade delete<?php echo e($x->NPSN); ?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center"><i
                                                                    class="fa fa-trash"></i><br>  Anda yakin ingin menghapus data ini?<br><?php echo e($x->NPSN); ?>

                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger light"
                                                                    data-bs-dismiss="modal">Batalkan</button>
                                                                <a href="delete-school/<?php echo e($x->NPSN); ?>">
                                    ...
                                    <div class="modal fade edit<?php echo e($x->NPSN); ?>" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="update-school/<?php echo e($x->NPSN); ?>" method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-xl-4">
                                                                    <label for="iduser">NPSN</label>
                                                                    <input type="text" class="form-control" id="nama"
                                                                        value="<?php echo e($x->NPSN); ?>"
                                                                        placeholder="Enter ID NPSN" name="id" readonly>
                                                                </div>
                                                                <div class="col-xl-8">
                                                                    <label for="iduser">Nama Sekolah</label>
                                                                    <input type="text" class="form-control" id="nama"
                                                                        value="<?php echo e($x->nama_sekolah); ?>"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="Address" id="" cols="30" rows="5"
                                                                class="form-control"><?php echo e($x->alamat); ?></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="iduser">Kabupaten/Kota</label>
                                                            <input class="form-control" list="datalistOptionsSekolah"
                                                                id="exampleDataList" name="kota" value="<?php echo e($x->kota); ?>">
                                                            <datalist id="datalistOptionsSekolah">
                                                                <option value="Purwakarta">Purwakarta</option>
                                                                <option value="Subang">Subang</option>
                                                                <option value="Karawang">Karawang</option>
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/sekolah/data-school-admin.blade.php ENDPATH**/ ?>