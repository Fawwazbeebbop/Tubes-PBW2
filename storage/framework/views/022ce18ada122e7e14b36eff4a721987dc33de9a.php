                        ...
                        <div>
                                    <?php if($viewData->foto != null): ?>
                                        <img class="avatar-lg rounded-circle img-thumbnail"
                                            src="<?php echo e(url('/' . $viewData->foto)); ?>" alt="" width="100px" />
                                    <?php else: ?>
                                        <img class="avatar-lg rounded-circle img-thumbnail"
                        ...
                        <div class="table-responsive mt-4">
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <div class="mt-4">
                                    ...
                                    <h5 class="font-size-16">
                                                <?php echo e($viewData->no_hp); ?>

                                    </h5>
                                </div>
                                <div class="mt-4">
                                    <p class="mb-1">E-mail :</p>
                                    <h5 class="font-size-16"><?php echo e($viewData->email); ?></h5>
                                </div>
                            ...
                            <div class="tab-content">
                                <div id="about-me" class="tab-pane fade active show">
                                    <div class="profile-personal-info">
                                            <br>
                                                <?php if($viewData->no_hp == null || $viewData->tempat_lahir == null || $viewData->gender == null || $viewData->alamat == null): ?>
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-sm-9 col-7"><?php echo e($viewData->nama); ?>
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-sm-9 col-7">
                                                        <?php echo e($viewData->tempat_lahir); ?>
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-sm-9 col-7">
                                                        <?php echo e($viewData->tanggal_lahir); ?>
                                    ...
                                    <div class="profile-about-me">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-sm-3 col-5">
                                                <h2>
                                                            <a href="https://www.instagram.com/<?php echo e($viewData->instagram); ?>/"><i
                                ...
                                <div id="profile-settings" class="tab-pane fade">
                                    <div class="pt-3">
                                        <div class="settings-form">
                                            ...
                                            <form action="<?php echo e(route('update-user', $viewData->user_id )); ?>" method="POST" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="userid" value="<?php echo e(auth()->user()->id); ?>">
                                                <div class="row">
                                                    <div class="mb-3 col-md-6">
                                                        <label class="form-label">Nama</label>
                                                        <input type="text" value="<?php echo e($viewData->nama); ?>"
                                                            class="form-control" name="nama" readonly>
                                                        
                                                    </div>
                                                    <div class="mb-3 col-md-6">
                                                        <label class="form-label">Email</label>
                                                        <input type="email" value="<?php echo e($viewData->email); ?>"
                                                            class="form-control" name="email" readonly>
                                                    </div>
                                                </div>
                                                        <input type="hidden" name="id" class="form-control-file"
                                                            value="<?php echo e($viewData->user_id); ?>">
                                                        <div class="row">
                                                            <div class="mb-3 col-md-6">
                                                                <label class="form-label">Jenis Kelamin</label>
                                                                <?php if($viewData->gender != null): ?>
                                                        <?php if($viewData->gender == 'Perempuan'): ?>
                                                            <select class="form-control wide" name="jk"
                                                                value="<?php echo e(old('jk')); ?>">
                                                                <option value="<?php echo e($viewData->gender); ?>" selected>
                                                                    <?php echo e($viewData->gender); ?></option>
                                                    ...
                                                    <?php endif; ?>
                                                            ...
                                                            <div class="mb-3 col-md-6">
                                                                ...
                                                                <input type="hidden" name="pathFoto"
                                                                    class="form-control-file" value="<?php echo e($viewData->foto); ?>">
                                                                <img class="avatar-lg rounded-circle img-thumbnail"
                                                                    src="<?php echo e(url('/' . $viewData->foto)); ?>" width="75px"
                                                                    height="auto" alt="">
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-3 col-md-6">
                                                                ...
                                                                <input type="text" value="<?php echo e($viewData->tempat_lahir); ?>" value="<?php echo e(old('tempat')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="mb-3 col-md-6">
                                                                ...
                                                                <input type="date" value="<?php echo e($viewData->tanggal_lahir); ?>" value="<?php echo e(old('tanggal')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="alamat" id="" cols="30" rows="5"
                                                                class="form-control"><?php echo e($viewData->alamat); ?></textarea>
                                                        </div>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-6">
                                                                <label class="form-label">No HP</label>
                                                                <input type="text" value="<?php echo e($viewData->no_hp); ?>" value="<?php echo e(old('hp')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="mb-3 col-md-6">
                                                                <label class="form-label">Sosial Media
                                                                    Instagram</label>
                                                                <input type="text" value="<?php echo e($viewData->instagram); ?>" value="<?php echo e(old('ig')); ?>"
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/user/data-user-detail.blade.php ENDPATH**/ ?>