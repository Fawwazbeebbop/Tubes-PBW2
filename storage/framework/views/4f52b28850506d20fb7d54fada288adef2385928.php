                            ...
                            <tbody>
                                <?php $__currentLoopData = $viewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo e(asset($x->foto_prodi)); ?>" width="200px" height="200" alt=""></td>
                                        <td>
                                            <div class="d-flex">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-12">
                                                                    <label for="iduser">Jenjang Program Studi</label>
                                                                    <input type="text" class="form-control" id="jenjang"
                                                                        value="<?php echo e($x->jenjang_prodi); ?>"
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pmb-project-main\resources\views/prodi/data-studyProgram-admin.blade.php ENDPATH**/ ?>